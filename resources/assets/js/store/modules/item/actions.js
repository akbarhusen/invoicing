...
export const fetchCompanies = ({ commit, dispatch, state }, params) => {
    return new Promise((resolve, reject) => {
        window.axios
            ...
            .then((response) => {
                commit(types.BOOTSTRAP_ITEMS, response.data.companies.data)
                commit(types.SET_TOTAL_ITEMS, response.data.companyTotalCount)
                resolve(response)
            })
            .catch((err) => {
                reject(err)
...
export const updateCompanyLogo = ({ commit, dispatch, state }, data) => {
    return new Promise((resolve, reject) => {
        window.axios
            .post(`/api/v1/companies/update-company-logo`, data)
            .then((response) => {
                // commit(types.UPDATE_ITEM, response.data)
                resolve(response)
            })
...
export const deleteCompany = ({ commit, dispatch, state }, id) => {
    return new Promise((resolve, reject) => {
        window.axios
            .post(`/api/v1/companies/delete`, id)
            .then((response) => {
                commit(types.DELETE_ITEM, id)
                resolve(response)
            })
